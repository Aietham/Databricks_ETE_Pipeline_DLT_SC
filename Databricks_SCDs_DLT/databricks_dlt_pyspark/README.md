# databricks_dlt_pyspark

The 'databricks_dlt_pyspark' project was generated by using the default template.

* `src/`: Python source code for this project.
  * `src/databricks_dlt_pyspark/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databricks_dlt_pyspark_etl` to your workspace.
